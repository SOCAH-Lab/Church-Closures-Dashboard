...
Shelby Golden, MS from the Yale School of Public Health [Data Science and Data Equity](https://ysph.yale.edu/research/research-centers-and-initiatives/public-health-data-science-and-data-equity/) team was contracted to review and update the data cleaning, validation, and harmonization methods previously employed by [Dr. Insang Song](https://sigmafelix.wixsite.com/mysite) to generate data compatible with dynamic visualization on the dashboard map.
...
**Project Principal Investigator (PI):** [Yusuf Ransome, MPH, DrPH](https://ysph.yale.edu/profile/yusuf-ransome/)

**Project Manager:** [Katelyn Kostakis, MPH](https://www.linkedin.com/in/katelyn-kostakis/)

**Developer and Analyst:** [Shelby Golden, MS](https://www.linkedin.com/in/shelby-golden/)
...
![Collaborator logos](Collaborator%20Logos/logo-grid-composite.png)
