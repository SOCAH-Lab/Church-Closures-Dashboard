...
## 
##   34. normalize_address: Normalize an address string for comparison.
...
##            over-normalize
## 
##   35. compare_tabs: Compare "new" vs "old" tabs on (address, year) keys.
...
## 
##   36. compile_parquet_folder: Compile a folder of Parquet result files and 
...
##       $$is.na()$$, and $$table()$$.
## 
##   37. extract_range: Extract a numeric range (from/to) from a string like 
...
##       `to`.
## 
##   38. compile_duckdb_folder: Compile DuckDB QC outputs from a folder 
...
## 
##   39. write_qc_groups: Writes multiple *groups* of QC tables into an open 
...
## 
##   40. rbind_qc: Row-bind two QC tables with column alignment (NULL-safe).
...
## 
##   41. flag_boxplot: Boxplot + jitter for QC flag distributions across 
...
## 
##   42. join_places_with_zip_fix: Join city/state records to a places table, 
