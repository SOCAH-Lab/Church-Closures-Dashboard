...
##
##    5. validate_geocoordinates_geoCoder: This function validates an address by
...
##
##    7. validate_usps_address: This function validates an address using the 
...
##       the group.
##
##   15. is_acronym_or_city: This function checks if a given string is an 
##       acronym or a city name using regular expressions for acronyms and a US 
##       city database for city names.
##
##   16. capture_warnings: This function evaluates an expression and captures 
##       any warnings generated during the evaluation. 
##
##   17. get_census_tract_geocoder: This function takes an address string,
##       splits it  into components, and uses the Census Geocoder API to get
##       census tract information for that address.
##       Source: https://geocoding.geo.census.gov/geocoder/
##
##   18. get_tracts_for_year: This inner function used by 
##       find_census_info_tidycensus() retrieves census tract data for a 
##       specified year.
##
##   19. find_census_info_tidycensus: This function finds the census tract, 
...
##
##   20. decide_reference: This function finds the relevant reference period for 
...
##       the most.
##
##   21. replace_trailing_zeros: To calculate the persistence lookahead 
...
## 
##   22. calculate_persistence: This function calculates the persistence ratio 
##       of a church being open in a subset period compared to the full span of 
##       time recorded.
##
##   23. mutate_with_progress: This function processes each group within a data 
