...
**Date Updated:** August 7<sup>th</sup>, 2026
...
Refer to Appendix - [Primary SIC Codes and Descriptions](#code-results-source-2) and [All SIC Codes and Descriptions](#code-results-source-1) for information on where to find the code that generates these results, as well as the results codebook.
...
Refer to Appendix - [State-Level Shapefile for Basemap](#code-results-source-3), [Missing Address Lines and PO Boxes By City](#code-results-source-4), [GEOID Prebuild Shapefiles](#code-results-source-5), [Core Area CBSA/CSA Prebuild Shapefiles](#code-results-source-6), [Core Area ZCTA Prebuild Shapefiles](#code-results-source-7) for information on where to find the code that generates these results, as well as the results codebook.
...
## State-Level Shapefile for Basemap {#code-results-source-3}
...
## Core Area CBSA/CSA Prebuild Shapefiles {#code-results-source-6}
...
## Core Area ZCTA Prebuild Shapefiles {#code-results-source-7}
