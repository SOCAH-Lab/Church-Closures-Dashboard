...
Refer to Appendix - [Optimizing Data Subsetting](#code-results-source-1) and [Optimizing Data Combination](#code-results-source-2) for information on where to find the code that generates these results, as well as the results codebook.
