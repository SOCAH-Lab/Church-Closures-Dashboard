...
counts_data <- c(
  359, 3490, 12926, 130819,  # Year Established = FALSE
  694, 7360, 31922, 0       # Year Established = TRUE
)

# Data for the percentage table
percentage_data <- c(
  0.19, 1.86, 6.89, 69.74,  # Year Established = FALSE
  0.37, 3.92, 17.02, 0.00   # Year Established = TRUE
)
...
1. A PO Box address is used either before or after other addresses.
2. A PO Box address is used between other addresses for more than three consecutive years.

The second point can result in a skew because Professor Ransome and Dr. Insang's methods define a church closure as occurring when more than three consecutive zeros are observed from 2001 to 2021. As a result, sequences like “10001” and “101” are replaced with “11111” and “111,” respectively.

Examples are indexed in the "Explore the Raw Data.R" file under the section *ASSUMPTION TO REMOVE PO BOX'S*. Only those with access to the full data will be able to see these examples.
