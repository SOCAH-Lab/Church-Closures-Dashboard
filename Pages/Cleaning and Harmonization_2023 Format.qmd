...
:::{.callout-warning}
Add note here that this is the 2023 format. Update links to repo and file references. Add codebook?
:::
...
Selected code excerpts are provided below. The complete code used to generate this report can be found in [Code/Clean Raw Data_Step 1.R](https://github.com/ysph-dsde/church-closures/blob/main/Code/Clean%20Raw%20Data_Step%201.R).
